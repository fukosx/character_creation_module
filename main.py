...
def attack(char_name: str, char_class: str) -> str:
    """Эта функция описывает атаку персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Эта функция описывает оборону персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Эта функция описывает специальное умение."""
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Эта функция опсиывает выбор персонажа."""
    approve_choice: str = ''
    char_class: str = ''
